...
# Generate synthetic samples
Y_sim_multi = simulator_multi.sample(n_samples=500)
...
# Generate synthetic samples
Y_sim_mixture = simulator_mixture.sample(n_samples=800)
...
# Generate test data
Y_test = np.random.multivariate_normal([0, 0], [[1, 0.5], [0.5, 1]], 300)
...
for method in sampling_methods:
    ...
    Y_sim_test = sim.sample(n_samples=300)
